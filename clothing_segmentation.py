...
def load_pair(idx, shape=(256, 256)):
...
class ConvSimplifier(hk.Module):
    ...
    def __call__(self, x, is_training):
        ...
        x8 = hk.Conv2D(4096, 3, 2, padding="SAME", w_init=w_init, b_init=b_init)(x7)
...
class ConvInverse(hk.Module):
    ...
    def __call__(self, x, is_training):
        ...
        val = hk.Conv2DTranspose(4096, 3, stride=1, padding="SAME", w_init=w_init, b_init=b_init)(xl)
